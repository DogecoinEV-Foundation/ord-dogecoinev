...
<html lang=en>
  ...
  <header>
    <nav>
      <a href=/>DogecoinEV-Ordinals<sup>alpha</sup></a>
      .*
...
"
  ...
  fn page_mainnet() {
    assert_regex_match!(
      ...
      r".*<nav>\s*<a href=/>DogecoinEV-Ordinals<sup>alpha</sup></a>.*"
    );
  }
  ...
  fn page_no_sat_index() {
    assert_regex_match!(
      ...
      r".*<nav>\s*<a href=/>DogecoinEV-Ordinals<sup>alpha</sup></a>.*\s*<form action=/search.*",
    );
  }
  ...
  fn page_signet() {
    assert_regex_match!(
      ...
      r".*<nav>\s*<a href=/>DogecoinEV-Ordinals<sup>signet</sup></a>.*"
    );
  }
}
